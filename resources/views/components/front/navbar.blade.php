        ...
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center justify-between flex-grow">
                <div class="flex-shrink-0">
                    <h1 class="text-lg font-semibold tracking-widest text-grey-100 uppercase">
                        <a href="#">SEBAYA LABS</a>
                    </h1>
                </div>
                <div class="hidden lg:block">
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="flex flex-row items-center px-3 py-2 ml-4 text-sm font-medium text-grey-500 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                ...
                                <span class="mx-2">Source Code</span>
                            ...
                            <div @click.away="open = false" x-show="open"
                                ...
                                <div class="py-1 bg-white border border-lg rounded-md shadow-xs">
                                    <a href="#"
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div @click.away="open = false" x-show="open"
                                ...
                                x-transition:leave-end="transform opacity-0 scale-95"
                                class="absolute right-0 w-48 mt-2 origin-top-right rounded-md shadow-lg">
                                <div class="py-1 bg-white border border-1 rounded-md shadow-xs">
                                    <a href="#"
                                        class="flex flex-row items-center px-4 py-2 text-sm text-gray-700 focus:text-gray-900 hover:text-gray-900 focus:outline-none hover:bg-gray-100 focus:bg-gray-100">
                                        Trending
                                    </a>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden lg:hidden">
        <div class="container px-6 mx-auto">
            <div class="pt-2 pb-3">
                ...
                <a href="#"
                    class="flex flex-row items-center px-3 py-2 mt-1 text-base font-medium text-grey-500 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="feather feather-file">
                        <path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path>
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = true"
                        class="flex flex-row items-center w-full px-3 py-2 mt-1 text-base font-medium text-left text-grey-500 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="container px-6 mx-auto">
            <div x-data="{ open: false }" class="py-4 border-t border-gray-700">
                ...
                <div x-show="open" @click.away="open = false" class="py-2 mt-4 bg-white rounded-md shadow-xs"
